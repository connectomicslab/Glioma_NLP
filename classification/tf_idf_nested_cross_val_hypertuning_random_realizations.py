...
def tf_idf_classification(df_reports, df_comparative_dates_and_reports, max_features_random_forest, n_grams, percentage_vocab_size, cv_folds, random_realizations,
                          output_folder, remove_proper_nouns, remove_custom_words, lowercase, remove_punctuation, remove_stopwords, from_indication_onward, from_description_onward, binary_classification=True):
